...
public class Strassen_Leaf2 {
    ...
    public int[][] multiplyMatrix(int[][]matrixA, int[][]matrixB){
        ...
        if(size==2){
            matrixC[0][0] = (matrixA[0][0]*matrixB[0][0])+(matrixA[0][1]*matrixB[1][0]); //C11 = (a11*b11)+(a12*b21)
            matrixC[0][1] = (matrixA[0][0]*matrixB[0][1])+(matrixA[0][1]*matrixB[1][1]); //C12 = (a11*b12)+(a12*b22)
            matrixC[1][0] = (matrixA[1][0]*matrixB[0][0])+(matrixA[1][1]*matrixB[1][0]); //C21 = (a21*b11)+(a22*b21)
            matrixC[1][1] = (matrixA[1][0]*matrixB[0][1])+(matrixA[1][1]*matrixB[1][1]); //C22 = (a21*b11)+(a22*b21)
        }
        else{
    ...
    //linear multiplication for small base case
    public int[][] smallMult(int[][]matrixA,int[][]matrixB){
        //get the matrix size
        int size = matrixA.length;
